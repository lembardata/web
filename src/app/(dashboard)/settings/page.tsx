              ...
              {apiKeys.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-muted-foreground text-center">
                    Buat API key pertama Anda untuk mulai menggunakan SpreadsheetAI API
                  </p>
                </div>
              ) : (
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground">
                            ...
                            <span>•</span>
                            <span>
                              Terakhir digunakan: {apiKey.lastUsed ? formatDate(apiKey.lastUsed) : 'Belum pernah'}
                            </span>
                          </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-base font-medium">Profil Publik</Label>
                    <p className="text-sm text-muted-foreground">
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          ...
                          dan tidak dapat dipulihkan. Tindakan ini tidak dapat dibatalkan.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
                        <AlertDialogCancel>Batal</AlertDialogCancel>
