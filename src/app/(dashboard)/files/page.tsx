...
export default function FilesPage() {
  ...
  const [files] = useState<SpreadsheetFile[]>([
    {
      ...
      visibility: 'private',
      tags: ['sales', 'q4', '2023'],
      description: 'Data penjualan kuartal 4 tahun 2023 dengan breakdown per produk dan region',
      downloadUrl: '#',
      previewUrl: '#'
    },
    {
      ...
      description: 'Tracking inventory real-time dengan status stock dan reorder points',
      downloadUrl: '#',
      previewUrl: '#'
    },
    {
      ...
      description: 'Database customer lengkap dengan informasi kontak dan riwayat transaksi'
    },
    {
      id: 'file4',
  ...
  const handleFileUpload = useCallback(async (files: FileList | File[]) => {
    ...
    if (validFiles.length !== fileArray.length) {
      toast.error('Beberapa file tidak didukung. Hanya file Excel (.xlsx, .xls) dan CSV yang diizinkan.');
    }
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="mt-2">
                  <Progress 
                    value={(fileStats.storageUsed / fileStats.storageLimit) * 100} 
                    className="h-2"
                  />
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">{fileStats.recentUploads}</p>
      ...
      >
        <CardContent className="pt-6">
          <div className="text-center py-8">
            <CloudUpload className={`h-16 w-16 mx-auto mb-4 ${
            ...
            <p className="text-sm text-gray-500 mb-4">
              Mendukung file Excel (.xlsx, .xls) dan CSV dengan ukuran maksimal 10MB
            </p>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Apakah Anda yakin ingin menghapus {selectedFiles.length} file yang dipilih? 
                  ...
                  {file.status === 'ready' && (
                    <div className="text-xs text-gray-500 space-y-1">
                      {file.rowCount && file.columnCount && (
                        <p>{file.rowCount.toLocaleString()} rows × {file.columnCount} cols</p>
                      )}
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="p-4 text-left font-medium text-gray-900">Size</th>
                    <th className="p-4 text-left font-medium text-gray-900">Status</th>
                    <th className="p-4 text-left font-medium text-gray-900">Visibility</th>
